...
public class PraticaDoIf{
    ...
    public char letraCentral(Cliente cliente){
        String nome = cliente.getNome();
        int indiceDaLetraDoMeio = nome.length()/2;
        char letraDoMeio = nome.charAt(indiceDaLetraDoMeio);
        
        return letraDoMeio;
    }
    
    public String primeiroNome(Cliente cliente){
        String nome = cliente.getNome();
        if (nome.indexOf(" ") != -1){
