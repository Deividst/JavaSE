...
public class EmpregadoVendedor extends Empregado {
	...
	public void emiteContraCheque() {
		...
		for (int i = 0; i < totalVendasDia.length; i++) {
			...
			System.out.println("Valor da Comissão: " + this.valorTotalComissao);
		}
	}
	...
	public double[] tresMelhoresDias() {
		...
		double[] venda = new double[totalVendasDia.length];
	...
	public void relatorioVendas() {
		System.out.println("Dia do mês ---- Total Vendido - R$");
		for (int i = 0; i < totalVendasDia.length; i++) {
			System.out.printf("%d%s%.2f\n", (i+1)," ---- ", totalVendasDia[i]);
		}
	}
